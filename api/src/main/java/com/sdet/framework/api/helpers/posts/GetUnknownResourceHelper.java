...
@Slf4j
@SuperBuilder
public class GetUnknownResourceHelper extends BaseApiHelper {
  private String endpoint;
  private Response response;

  @Override
  public ServiceHelper init() {
    endpoint = JsonPlaceholderEndpointManager.url(JsonPlaceholderEndpoints.UNKNOWN_RESOURCE);
    log.info("Negative test endpoint: {}", endpoint);
    return this;
  }

  @Override
  public ServiceHelper process() {
    response = RestUtils.get(endpoint, Map.of(), null);
    return this;
  }

  @Override
  public ServiceHelper validate() {
    PostValidator.wasNotFound(response);
    return this;
  }
}
