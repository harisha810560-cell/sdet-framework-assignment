...
/** PATCH a subset of an existing post's fields. */
@Getter
@Slf4j
@SuperBuilder
public class UpdatePostHelper extends BaseApiHelper {
  ...
  public ServiceHelper init() {
    ...
    log.info("PATCH endpoint: {}, payload: {}", endpoint, request);
    return this;
  }

  @Override
  public ServiceHelper process() {
    response = RestUtils.patch(endpoint, Map.of(), request);
    return this;
  }

  @Override
  public ServiceHelper validate() {
    PostValidator.wasUpdated(response, apiTestContext.getExistingPostId(), request);
    return this;
  }
}
