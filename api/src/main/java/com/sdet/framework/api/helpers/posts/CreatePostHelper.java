...
/** POST a new post from a builder-pattern payload. */
@Getter
@Slf4j
@SuperBuilder
public class CreatePostHelper extends BaseApiHelper {
  ...
  public ServiceHelper init() {
    ...
    log.info("POST endpoint: {}, payload: {}", endpoint, request);
    return this;
  }

  @Override
  public ServiceHelper process() {
    response = RestUtils.post(endpoint, Map.of(), request);
    return this;
  }

  @Override
  public ServiceHelper validate() {
    PostValidator.wasCreated(response, request);
    return this;
  }
}
