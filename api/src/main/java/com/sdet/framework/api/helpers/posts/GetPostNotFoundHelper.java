...
@Slf4j
@SuperBuilder
public class GetPostNotFoundHelper extends BaseApiHelper {
  ...
  public ServiceHelper init() {
    endpoint =
        JsonPlaceholderEndpointManager.url(
            JsonPlaceholderEndpoints.POST_BY_ID, apiTestContext.getInvalidPostId());
    log.info("GET invalid endpoint: {}", endpoint);
    return this;
  }
