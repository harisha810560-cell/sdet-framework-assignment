...
@Slf4j
@SuperBuilder
public class GetAllPostsHelper extends BaseApiHelper {
  ...
  public ServiceHelper init() {
    ...
    log.info("GET collection endpoint: {}", endpoint);
    return this;
  }
  ...
  public ServiceHelper validate() {
    PostValidator.hasPostCollection(response, ApiConstants.SEEDED_POST_COUNT);
    return this;
  }
}
